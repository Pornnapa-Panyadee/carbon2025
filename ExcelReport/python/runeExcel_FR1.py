...
# ----------------- File Paths -----------------
template_path = "ExcelReport/excel/form_CFP_pdf_fr01.xlsx"
...
ws01["J13"] = f"{product.get('FU_value','0')} {product.get('FU_th','')}" if product.get('FU_value') else "0"
ws01["J14"] = f"{product.get('FU_value','0')} {product.get('FU_en','')}" if product.get('FU_value') else "0"
ws01["J15"] = f"{product.get('PU_value','0')} {product.get('PU_th','')}" if product.get('PU_value') else "0"
ws01["J16"] = f"{product.get('PU_value','0')} {product.get('PU_en','')}" if product.get('PU_value') else "0"
...
output_pdf = os.path.join(output_dir, f"{timestamp}_Company{company.get('company_id','')}_Product{product.get('product_id','')}_Fr01.pdf")
