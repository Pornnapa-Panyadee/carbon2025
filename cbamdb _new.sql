...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 19, 2025 at 06:55 AM
...
INSERT INTO `cn_codes` (`id`, `name`, `cn_code`, `goods_category_id`, `created_at`, `updated_at`) VALUES
...
--
ALTER TABLE `cn_codes`
  ADD CONSTRAINT `cn_codes_ibfk_1` FOREIGN KEY (`goods_category_id`) REFERENCES `goods_categories` (`id`);
