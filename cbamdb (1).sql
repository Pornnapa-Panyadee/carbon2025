...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 19, 2025 at 12:22 PM
...
INSERT INTO `cn_codes` (`un_id`, `name`, `cn_code`, `goods_category_id`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `reports` (`id`, `installation_id`, `reporting_period_start`, `reporting_period_end`, `verifier_id`, `industry_type_id`, `goods_id`, `un_id`, `created_at`, `updated_at`, `company_id`) VALUES
...
(2, 'ทดสอบ ใจดีมาก', NULL, 'Chiang Mai', 221, '50000', 1, NULL, NULL, NULL, NULL, NULL);
